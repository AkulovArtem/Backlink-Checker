...
- Опциональная проверка индексации в Google через XMLRiver или XMLStock (только доноры с найденным бэклинком)
...
2. Нажмите «Настройки» и вставьте персональный URL XMLRiver и/или XMLStock (в кабинете сервиса). Баланс подтянется сам. Кнопки: «Сохранить» и «Отмена».
...
6. Чтобы докинуть ссылки в готовое задание: меню ⋮ → «Добавить ссылки». Проверятся только новые URL, старые результаты останутся.
